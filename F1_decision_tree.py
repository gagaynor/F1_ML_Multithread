...
upcoming_race_df = pd.DataFrame({
    'DRIVER_A ALBON': [0], 'DRIVER_A GIOVINAZZI': [0],
    ...
    'DRIVER_M VERSTAPPEN': [1], 'DRIVER_N DE VRIES': [0], 'DRIVER_N HULKENBERG': [0],
    ...
    'TEAM_Alfa Romeo': [0], 'TEAM_Alfa Romeo Racing': [0], 'TEAM_AlphaTauri':[0],
